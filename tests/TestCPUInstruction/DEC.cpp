...
Test(DEC_B, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x5, gb.cpu, gb.cpu._registers);
...
Test(DEC_C, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0xD, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_D, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x15, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_E, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x1D, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_H, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x25, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_L, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x2D, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_A, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x3D, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_BC, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0xB, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_DE, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x1B, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_HL, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x2B, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(DEC_SP, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x3B, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);

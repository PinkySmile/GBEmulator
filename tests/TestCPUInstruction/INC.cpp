...
Test(INC_B, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x4, gb.cpu, gb.cpu._registers);
...
Test(INC_C, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0xC, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_DE, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x13, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_D, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x14, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_E, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x1C, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_HL, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x23, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_H, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x24, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_L, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x2C, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_SP, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x33, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_unrefHL, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x34, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_A, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x3C, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);
...
Test(INC_BC, value_1) {
	...
	unsigned char time = GBEmulator::Instructions::executeInstruction(0x3, gb.cpu, gb.cpu._registers);
	cr_assert_eq(time, excepted_time, "Execution time must be %d but it was %d", excepted_time, time);

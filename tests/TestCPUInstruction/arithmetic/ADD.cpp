...
Test(ADD_A_B, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		for (unsigned j = 0; j <= 0xFF; j++) {
			...
			unsigned time = GBEmulator::Instructions::executeInstruction(0x80, gb.cpu, gb.cpu._registers);
...
Test(ADD_A_C, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		for (unsigned j = 0; j <= 0xFF; j++) {
			...
			unsigned time = GBEmulator::Instructions::executeInstruction(0x81, gb.cpu, gb.cpu._registers);
...
Test(ADD_A_D, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		for (unsigned j = 0; j <= 0xFF; j++) {
			...
			unsigned time = GBEmulator::Instructions::executeInstruction(0x82, gb.cpu, gb.cpu._registers);
...
Test(ADD_A_E, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		for (unsigned j = 0; j <= 0xFF; j++) {
			...
			unsigned time = GBEmulator::Instructions::executeInstruction(0x83, gb.cpu, gb.cpu._registers);
...
Test(ADD_A_H, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		for (unsigned j = 0; j <= 0xFF; j++) {
			...
			unsigned time = GBEmulator::Instructions::executeInstruction(0x84, gb.cpu, gb.cpu._registers);
...
Test(ADD_A_L, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		for (unsigned j = 0; j <= 0xFF; j++) {
			...
			unsigned time = GBEmulator::Instructions::executeInstruction(0x85, gb.cpu, gb.cpu._registers);
...
Test(ADD_A_HL_UNREF, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		for (unsigned j = 0; j <= 0xFF; j++) {
			...
			unsigned time = GBEmulator::Instructions::executeInstruction(0x86, gb.cpu, gb.cpu._registers);
...
Test(ADD_A_A, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		...
		unsigned time = GBEmulator::Instructions::executeInstruction(0x87, gb.cpu, gb.cpu._registers);
...
Test(ADD_A_val, all_values) {
	...
	for (unsigned i = 0; i <= 0xFF; i++) {
		for (unsigned j = 0; j <= 0xFF; j++) {
			...
			unsigned time = GBEmulator::Instructions::executeInstruction(0xC6, gb.cpu, gb.cpu._registers);

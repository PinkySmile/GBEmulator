...
namespace GBEmulator::Instructions
{
	...
	const std::function<std::string (const CPU &, unsigned short)> _instructionsString[256] = {
		...
		[](const CPU &cpu, unsigned short address) { return "JR " + intToHex(static_cast<char>(cpu.read(address))); },
		...
		[](const CPU &cpu, unsigned short address) { return "JR nz," + intToHex(static_cast<char>(cpu.read(address))); },
		...
		[](const CPU &cpu, unsigned short address) { return "JR z," + intToHex(static_cast<char>(cpu.read(address))); },
		...
		[](const CPU &cpu, unsigned short address) { return "JR nc," + intToHex(static_cast<char>(cpu.read(address))); },
		[](const CPU &cpu, unsigned short address) { return "LD sp, " + intToHex(static_cast<char>(cpu.read(address))); },
		...
		[](const CPU &cpu, unsigned short address) { return "JR c," + intToHex(static_cast<char>(cpu.read(address))); },
